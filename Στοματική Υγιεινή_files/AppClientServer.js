...
addAppClientTranslation("RO",
                        "APPCLIENT_CHARACTERS","abcdefghijklmnopqrstuvwxyzășțîâ");
addAppClientTranslation("RO",
                        "APPCLIENT_FULLSCREEN","Arată exercițiul în ecran complet!");
addAppClientTranslation("RO",
                        "APPCLIENT_HINTLINK","Inserează sarcina de lucru");
addAppClientTranslation("RO",
                        "APPCLIENT_HELPLINK","Afișează asistența");
addAppClientTranslation("RO",
                        "APPCLIENT_HELPDESCRIPTION","Asistență");
addAppClientTranslation("RO",
                        "APPCLIENT_TASKDESCRIPTION","Temă");
addAppClientTranslation("RO",
                        "APPCLIENT_GIVEPARAM","Introduceți valoarea parametrului");
addAppClientTranslation("RO",
                        "APPCLIENT_CONNECTIONLOST","Legătura cu serverul App a fost întreruptă. O nouă legatură se realizează.");

addAppClientTranslation("RO",
                        "APPCLIENT_VIDEODELTED","Video-ul încă nu este sau nu mai este disponibil pe Youtube.");
addAppClientTranslation("RO",
                        "APPCLIENT_VIDEOFORBIDDEN","Autorul a interzis pe Youtube încorporarea acestui Audio/Video pe alte site-uri web.");
addAppClientTranslation("RO",
                        "APPCLIENT_VIDEOWRONGURL","Youtube-URL este invalid");

addAppClientTranslation("RO",
                        "APPCLIENT_READSPEECH","Citește cu voce tare");
